...
%  \gls{submodule} (elim by anne)
  ...
  a potential \gls{snb}}
\newduneabbrev{etf}{ETF}{Experiment Test Framework}{WLCG testing middleware running grid jobs that actively test distributed sites services and capabilities, and report back to monitoring services (SAM3/MONIT)}
